...
const translations = {
  de: {
    ...
    'founder.roles': 'Mathematikerin. Medizinerin. Ingenieurin. Rennfahrerin.',
    ...
    'founder.data': 'Datenanalyse',
    'founder.data.desc': 'Echtzeitdatenanalyse & Sensornetzwerke',
  ...
  en: {
    ...
    'founder.name': 'Hatice Tavlı',
    'founder.roles': 'Mathematician. Physician. Engineer. Race Driver.',
    ...
    'founder.data': 'Data Analysis',
    'founder.data.desc': 'Real-time data analysis & sensor networks',
  ...
  tr: {
    ...
    'founder.name': 'Hatice Tavlı',
    'founder.roles': 'Matematikçi. Doktor. Mühendis. Yarış Pilotu.',
    ...
    'founder.data': 'Veri Analizi',
    'founder.data.desc': 'Gerçek zamanlı veri analizi ve sensör ağları',
  ...
  ja: {
    ...
    'founder.roles': '数学者。医師。エンジニア。レースドライバー。',
    ...
    'founder.data': 'データ分析',
    'founder.data.desc': 'リアルタイムデータ分析とセンサーネットワーク',
