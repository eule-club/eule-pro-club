...
const translations = {
  de: {
    ...
    'founder.roles': 'Medizinstudentin. Mathematikerin. Ingenieurin. Rennfahrerin.',
    ...
    'founder.medical.desc': 'Medizinstudium & Systemdiagnostik',
  ...
  en: {
    ...
    'founder.name': 'Hatice Tavlı',
    'founder.roles': 'Medical Student. Mathematician. Engineer. Race Driver.',
    'founder.vision.title': 'Vision',
    ...
    'founder.medical.desc': 'Medical studies & system diagnostics',
  ...
  tr: {
    ...
    'founder.name': 'Hatice Tavlı',
    'founder.roles': 'Tıp Öğrencisi. Matematikçi. Mühendis. Yarış Pilotu.',
    ...
    'founder.medical.desc': 'Tıp eğitimi & sistem tanılamaları',
  ...
  ja: {
    ...
    'founder.roles': '医学生。数学者。エンジニア。レースドライバー。',
