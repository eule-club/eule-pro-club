        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h3 className="text-3xl font-bold text-black mb-4">{t('founder.name')}</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 p-6 rounded-xl border-l-4 border-red-500">
                  ...
                  <h5 className="font-semibold text-black mb-2">{t('founder.ai')}</h5>
                  <p className="text-gray-600 text-sm">{t('founder.ai.desc')}</p>
                </div>
              </div>
              
              <div className="bg-red-500 p-6 rounded-xl text-white">
                <h5 className="text-xl font-semibold mb-3">{t('founder.inventor')}</h5>
